...
Installing the PHP version of Pattern Lab should be fairly painless. First make sure you have the [required version of PHP](/docs/requirements.html) and then:
